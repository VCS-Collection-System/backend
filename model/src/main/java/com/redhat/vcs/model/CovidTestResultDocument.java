...
@NamedQuery(
    ...
    query = "SELECT d FROM CovidTestResultDocument d WHERE d.employee.employeeId=:employeeId"
)
@NamedQuery(
    name = "covid_test_result_doc_by_employee_id_and_agency_name",
    query = "SELECT d FROM CovidTestResultDocument d WHERE d.employee.employeeId=:employeeId and lower(d.employee.agencyName)=lower(:agencyName)"
)
public class CovidTestResultDocument extends Document implements Serializable {
    ...
    public List<String> validate() {
        ...
        if (getCovidTestDate() == null) {
            errors.add("COVID test result date is missing.");
        }
        if (getCovidTestResult() == null) {
    ...
    public String toString() {
        return "CovidTestResultDocument [covidTestDate=" + getCovidTestDate()
                + ", covidTestResult=" + getCovidTestResult()
                + " # " + super.toString() + "]";
    }
}
