...
@NamedQuery(
    ...
    query = "SELECT d FROM EmployeeLog d WHERE d.employeeId=:employeeId and lower(d.agencyName)=lower(:agencyName)"
)
public class EmployeeLog implements Serializable {
    ...
    @Column(name = "changes", length = 5000)
    ...
    public String toString() {
        return "EmployeeLog ["
                ...
                + ", fullTimePartTime=" + getFullTimePartTime()
                + ", id=" + getId()
                + ", isHR=" + isHR()
                + ", lastName=" + Utils.maskedString()
                + ", timestamp=" + getTimestamp()
                + ", middleName=" + Utils.maskedString()
                + ", ncid=" + getNcid()
                + ", supervisor=" + getSupervisor()
                + ", userType=" + getUserType()
                + ", username=" + Utils.maskedString()
                + "]";
    }
