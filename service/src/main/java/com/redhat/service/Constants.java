...
public final class Constants {
    ...
    public static final String DOCUMENT_FIELD_NAME = "documents";
    ...
    public static final String KJAR_DEPLOYMENT_ID = System.getProperty("com.redhat.vcs.kjar.deployment.id", "rhvcs-kjar-2_0-SNAPSHOT");
    public static final String VACCINE_CARD_REVIEW_WORKFLOW = "vax_card_aas_review_workflow";
